...
namespace Domain.Data
{
    ...
    {
        private HalesFamilyContext _context;

        public DataAccess(HalesFamilyContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.ApplicationUser.FirstOrDefault(x => x.ApplicationUserId == id);
        }
        #endregion
        ...
        #region GetAppnUserViewByExternalId
        /// <summary>
        /// Gets the ApplicationUser.
        /// </summary>
        /// <param name="externalId">The external id.</param>
        ...
        public Suggestion InsertSuggestion(Suggestion file)
        {
            ...
            return _context.Suggestion.Where(x => x.SuggestionId == file.SuggestionId)
                .Join(_context.ApplicationUser,
                c => c.ApplicationuserId,
                a => a.ApplicationUserId,
                (c, a) => new Suggestion
