...
{
    public partial class HalesFamilyContext : DbContext
    {
        ...
        public HalesFamilyContext(DbContextOptions<HalesFamilyContext> options)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ApplicationUser>(entity =>
            {
                ...
                entity.HasOne(d => d.ExternalType)
                    .WithMany(p => p.ExternalType)
                    .HasForeignKey(d => d.ExternalTypeId)
